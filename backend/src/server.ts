...
// CORS configurado para produção e Expo. Apps nativos não usam CORS, mas web/Expo web usam.
...
const configuredOrigins = process.env.FRONTEND_URL
  ...
  : [];
const allowedOrigins = NODE_ENV === 'production' ? configuredOrigins : [...defaultDevOrigins, ...configuredOrigins];
