...
const serializeNotifications = (notifications: unknown) => JSON.stringify(notifications || defaultNotifications);
  ...
  try {
    ...
    const settings = await prisma.userSettings.upsert({
      ...
      update: {
        ...
        ...(data.notifications && { notifications: serializeNotifications(data.notifications) }),
      },
      create: {
        userId,
        geminiApiKey: data.geminiApiKey,
        theme: data.theme || 'light',
        notifications: serializeNotifications(data.notifications),
      },
      select: {
        id: true,
        geminiApiKey: true,
